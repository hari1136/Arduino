...
#ifndef ADE7758_H
#define ADE7758_H
#define EXTERNAL_CT_RATIO (50/5)
//extern int32_t intrstat;
/***
   Defines
...
// Class Atributes
#define AFECS 2             // Chip Select ADE7758 - Es el pin al que se conecta el AFE, luego le sumo 8 para compatibilizar con digitalwrite  
...
class ADE7758 {
  ...
  public:
    ...
    long cirms();
    int getFreq(void);
    void setSAGLVL(int m);
    void setVPINTLVL(int m);
    void setIPINTLVL(int m);
  ...
  public:
    ...
    int32_t read16(char reg);
    int32_t read24(char reg);
